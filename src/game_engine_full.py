...
class GameEngine:
    ...
    def initialize_game_world(self, scenario_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 2. Create the sim from scenario_data["sim_config"]
            # 3. Create the apartment layout from scenario_data["environment_config"]["layout"]
            # 4. Create all environment objects from scenario_data["environment_config"]["objects"]
